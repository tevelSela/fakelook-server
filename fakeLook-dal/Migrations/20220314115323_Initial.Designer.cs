...
namespace fakeLook_dal.Migrations
{
    ...
    [Migration("20220314115323_Initial")]
            ...
            modelBuilder.Entity("fakeLook_models.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 3, 14, 13, 53, 23, 129, DateTimeKind.Local).AddTicks(2437),
                            Description = "post 1",
                            ...
                            UserId = 1,
                            X_Position = 3.896296041607239,
                            Y_Position = 36.76181170718489,
                            Z_Position = 29.358531534492766
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2022, 3, 14, 13, 53, 23, 129, DateTimeKind.Local).AddTicks(2551),
                            Description = "post 2",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 2,
                            X_Position = 34.650920426039086,
                            Y_Position = 15.233840797908439,
                            Z_Position = 16.832760217717833
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2022, 3, 14, 13, 53, 23, 129, DateTimeKind.Local).AddTicks(2553),
                            Description = "post 3",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 3,
                            X_Position = 21.991236898792348,
                            Y_Position = 30.085177125234015,
                            Z_Position = 37.75562440641361
                        },
                        new
                        {
                            Id = 4,
                            Date = new DateTime(2022, 3, 14, 13, 53, 23, 129, DateTimeKind.Local).AddTicks(2555),
                            Description = "post 4",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 4,
                            X_Position = 10.407237148835137,
                            Y_Position = 25.770144491379028,
                            Z_Position = 31.144174638066634
                        },
                        new
                        {
                            Id = 5,
                            Date = new DateTime(2022, 3, 14, 13, 53, 23, 129, DateTimeKind.Local).AddTicks(2558),
                            Description = "post 5",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 5,
                            X_Position = 43.450528679752431,
                            Y_Position = 5.3515609196164879,
                            Z_Position = 26.722136084480624
                        });
                });
